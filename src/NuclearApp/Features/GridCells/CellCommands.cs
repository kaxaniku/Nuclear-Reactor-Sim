...
public record ConfigureSteamChannelCommand(int ReactorGridId, int X, int Y, SteamType Type) : IRequest, IRequiresValidReactor;
public record ConfigureAllSteamChannelsCommand(int ReactorGridId, SteamType Type) : IRequest, IRequiresValidReactor;
