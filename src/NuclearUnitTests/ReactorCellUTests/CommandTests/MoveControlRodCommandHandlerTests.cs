...
public class MoveControlRodCommandHandlerTests
{
    private readonly Mock<IUnitOfWork> _unitOfWorkMock;
    private readonly MoveControlRodCommandHandler _handler;

    public MoveControlRodCommandHandlerTests()
    {
        _unitOfWorkMock = new Mock<IUnitOfWork>();
        _handler = new MoveControlRodCommandHandler(_unitOfWorkMock.Object);
    }

    [Fact]
    public async Task Handle_ShouldMoveControlRod_WhenValidRequest()
    {
        // Arrange
        var request = new MoveControlRodCommand(1, 0, 0, 50);
    ...
    public async Task Handle_ShouldThrowInvalidOperationException_WhenInvalidTelemetryType()
    {
        ...
        var reactorGrid = new ReactorGrid
        {
            ...
            Cells = new List<Cell>
            {
                new Cell { ColumnType = ColumnType.ControlRods, X = 0, Y = 0, Telemetry = new FuelChannelTelemetryDto() }
            }
        };
